...
V2_PICK_RULES = [
    ...
    ("slider",     ["多少钱", "预算", "数量", "额度", "调到", "滑杆"]),
    ("rating",     ["打几分", "评分", "满意度", "几颗星"]),
    ("datetime",   ["什么时候", "约个时间", "哪天", "几点", "日期"]),
    ("rank",       ["排个序", "优先级", "先后顺序", "重要程度"]),
...
TEMPLATE_LIBRARY = [
    ...
    # 引导类
    {"component_type": "guide.steps", "name": "步骤说明书",
     "desc": "把操作流程拆成分步说明：标题 + 正文 + 步骤圆点翻页，读完记入完成率",
     "keywords": ["怎么办", "怎么申请", "流程", "步骤", "教程", "指引", "操作说明", "怎么弄"],
     "default_config": {"steps": [
         {"title": "准备材料", "body": "拍摄破损部位照片 2-3 张，找到订单号与货物照片，材料越全审核越快。"},
         {"title": "提交申请", "body": "在对话里发送「申请赔付」，按提示上传材料并确认赔付账户信息。"},
         {"title": "等待审核", "body": "审核一般 1-2 个工作日完成，进度会在对话中主动通知你，也可随时询问。"}]}},
