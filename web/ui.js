...
window.UI = (function () {
  ...
  const PLATFORMS = {
    ia: {
      name: "智能交互平台", home: "/web/index.html", productSwitcher: true,
      groups: [
        ...
        { title: "智能交互", items: [
          ...
          ["design", "品牌风格", "/web/design.html", "palette"],
          ["products", "产品与接入", "/web/products.html", "link"],
          ["playground:comp", "组件测试", "/web/playground.html#comp", "play"],
          ["dashboard:survey", "交互数据（v1 不做）", "/web/dashboard.html#survey", "chart"],
        ] },
      ],
    },
    router: {
      ...
      groups: [
        ...
        { title: "运营", items: [
          ...
          ["dashboard:routing", "路由数据分析", "/web/dashboard.html#routing", "activity"],
        ] },
      ],
    },
  };
